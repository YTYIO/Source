...
Status = 0
DevelopersQ = Redis:sismember(Tepthon.."DevelopersQ:Groups",UserId) 
P17_12 = Redis:sismember(Tepthon.."P17_12:Groups",UserId) 
Developers = Redis:sismember(Tepthon.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(Tepthon.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Tepthon.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Tepthon.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Tepthon.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Tepthon.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Tepthon.."Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(Tepthon.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(Tepthon.."DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(Tepthon.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Tepthon.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Tepthon.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Tepthon.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Tepthon.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Tepthon.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Tepthon.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Tepthon.."lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(Tepthon.."Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(Tepthon.."Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(Tepthon.."Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(Tepthon.."Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(Tepthon.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Tepthon.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Tepthon.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Tepthon.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(Tepthon.."Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(Tepthon.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Tepthon.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(Tepthon.."Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(Tepthon.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(Tepthon.."Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Tepthon.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(Tepthon.."Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(Tepthon.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Tepthon.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(Tepthon.."Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(Tepthon.."Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(Tepthon.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Tepthon.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(Tepthon.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(Tepthon.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Tepthon.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Tepthon.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
JabwaAll = Redis:sismember(Tepthon.."Jabwa:Groups",UserId) ,
ktmall = Redis:sismember(Tepthon.."ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(Tepthon.."Jabwa:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Tepthon.."SilentGroup:Group"..ChatId,UserId)
}
end
...
JoinChannel = true
local chh = Redis:get(Tepthon.."chfalse")
if chh then
...
msg.Name_Controller = 'المبرمج محمد '
...
elseif Redis:sismember(Tepthon.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Tepthon.."P17_12:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(Tepthon.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Tepthon.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Tepthon.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Tepthon.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Tepthon.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Tepthon.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Tepthon.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Tepthon.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Tepthon.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Tepthon.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Tepthon.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Tepthon.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Tepthon.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Tepthon) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Tepthon.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Tepthon.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Tepthon.."Status:Welcome"..msg_chat_id) then
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Tepthon.."Welcome:Group"..msg_chat_id)
if Welcome then 
if Jabwa.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Tepthon) then
return false
end
local floods = Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Tepthon = Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Tepthon.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Tepthon.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Tepthon.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Tepthon = 5
if Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Tepthon = Redis:hget(Tepthon.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(Tepthon..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(Tepthon..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(Tepthon..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(Tepthon.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Tepthon.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Tepthon.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'Jabwaned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Tepthon.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Tepthon.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Tepthon.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Tepthon.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Tepthon.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Tepthon.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Tepthon.."lockpin"..msg_chat_id)
...
Redis:incr(Tepthon.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Tepthon.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Tepthon.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Tepthon) then
local N = (Redis:get(Tepthon.."Name:Bot") or "تيبثون")
photo = LuaTele.getUserProfilePhotos(Tepthon)
...
Redis:set(Tepthon.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Tepthon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Tepthon.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Tepthon.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Tepthon.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Tepthon.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Tepthon.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Tepthon.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Tepthon.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Tepthon.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Tepthon.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Tepthon.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Tepthon.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Tepthon.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Tepthon.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Tepthon.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Tepthon.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Tepthon.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Tepthon.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Tepthon.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Tepthon.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Tepthon.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Tepthon.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Tepthon.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Tepthon.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Tepthon.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ ارسل تحذير〘 "..Filters.." 〙عند ارساله*","md",true)  
end
end
if text and (Redis:get(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Tepthon.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Tepthon.."Filter:Group"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Tepthon.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Tepthon.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Tepthon.."Filter:Group"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Tepthon.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Tepthon.."Filter:Group"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Tepthon.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Tepthon.."Filter:Group"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Tepthon.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Tepthon.."Filter:Group"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Tepthon.."Filter:Group"..DelFilters..msg_chat_id)
...
if text and Redis:get(Tepthon.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Tepthon.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Tepthon.."All:Get:Reides:Commands:Group"..text)
Redis:del(Tepthon.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Tepthon.."All:Command:List:Group",text)
...
Redis:del(Tepthon.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Tepthon.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Tepthon.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Tepthon.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Tepthon.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(Tepthon.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Tepthon.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Tepthon.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Tepthon.."All:Command:List:Group",text)
Redis:del(Tepthon.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end

if text and Redis:get(Tepthon.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Tepthon.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Tepthon.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم ازالة هاذا ⇦〘 "..text.." 〙*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(Tepthon.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Tepthon.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Tepthon.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Tepthon.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Tepthon.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(Tepthon.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Tepthon.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Tepthon.."Command:List:Group"..msg_chat_id,text)
Redis:del(Tepthon.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end
if Redis:get(Tepthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Tepthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Tepthon.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Tepthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(Tepthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Tepthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(Tepthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Tepthon.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ ترحيب المجموعه*","md",true)     
end
if Redis:get(Tepthon.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Tepthon.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(Tepthon.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Tepthon.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(Tepthon.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Tepthon.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(Tepthon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ✧ تم الغاء الاذاعه بالتثبيت *","md",true)  
end 
local list = Redis:smembers(Tepthon.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Tepthon.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Tepthon.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(Tepthon.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tepthon.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ✧ تم الغاء الاذاعه خاص *","md",true)  
end 
local list = Redis:smembers(Tepthon..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tepthon.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tepthon.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tepthon.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Tepthon.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(Tepthon.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Tepthon.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(Tepthon.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(Tepthon.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Tepthon.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(Tepthon.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(Tepthon.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(Tepthon.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(Tepthon.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Tepthon.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(Tepthon.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Tepthon.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Tepthon.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Tepthon.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(Tepthon.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(Tepthon.."List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴛᴇᴘᴛʜᴏɴ •𓄹', url='https://t.me/Tepthon'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Tepthon.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Tepthon.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Tepthon.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Tepthon.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id," ✧  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= Tepthon then
local test = Redis:get(Tepthon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Tepthon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Tepthon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Tepthon.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Tepthon.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Tepthon.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Tepthon.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Tepthon.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Tepthon.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Tepthon.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Tepthon.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Tepthon.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Tepthon.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(Tepthon.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Tepthon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Tepthon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Tepthon.."List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Tepthon..v..text)
end
Redis:del(Tepthon.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Tepthon.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id," ✧  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(Tepthon..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(Tepthon.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Tepthon.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Tepthon.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Tepthon.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Tepthon.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(Tepthon.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(Tepthon.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(Tepthon.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(Tepthon.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Tepthon.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(Tepthon.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(Tepthon.."Add:Rd:Sudo:video_note"..text)
if Text then 
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Tepthon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Tepthon..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(Tepthon.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(Tepthon.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Tepthon.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Tepthon.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Tepthon.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Tepthon.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(Tepthon.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(Tepthon.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(Tepthon.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(Tepthon.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Tepthon.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(Tepthon.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(Tepthon.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Tepthon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Tepthon..'GetTexting:DevTepthon'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(Tepthon..'GetTexting:DevTepthon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم الغاء حفظ كليشة المطور')
end
Redis:set(Tepthon..'Texting:DevTepthon',text)
Redis:del(Tepthon..'GetTexting:DevTepthon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم حفظ كليشة المطور')
end
if Redis:get(Tepthon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Tepthon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Tepthon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Tepthon.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم تعين الايدي عام',"md",true)  
end
if Redis:get(Tepthon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Tepthon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Tepthon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Tepthon.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Tepthon.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Tepthon.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Tepthon.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✧ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Tepthon.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Tepthon.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Tepthon.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✧ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Tepthon.."Game:Smile"..msg.chat_id) then
if text == Redis:get(Tepthon.."Game:Smile"..msg.chat_id) then
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Tepthon.."Game:Smile"..msg.chat_id)
...
if Redis:get(Tepthon.."Game:Jabwa"..msg.chat_id) then
if text == Redis:get(Tepthon.."Game:Jabwa"..msg.chat_id) then
Redis:del(Tepthon.."Game:Jabwa"..msg.chat_id)
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Tepthon.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(Tepthon.."Game:Riddles"..msg.chat_id) then
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Tepthon.."Game:Riddles"..msg.chat_id)
...
if Redis:get(Tepthon.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Tepthon.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Tepthon.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(Tepthon.."Gamection"..msg.chat_id) then
if text == Redis:get(Tepthon.."Gamection"..msg.chat_id) then
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Tepthon.."Gamection"..msg.chat_id)
...
if Redis:get(Tepthon.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Tepthon.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Tepthon.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id)
Redis:del(Tepthon.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ✧ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Tepthon.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Tepthon.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Tepthon.."TEAM:SAIDI"..msg.chat_id..msg.sender.user_id)
Redis:del(Tepthon.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Tepthon.."Game:Difference"..msg.chat_id) then
if text == Redis:get(Tepthon.."Game:Difference"..msg.chat_id) then 
Redis:del(Tepthon.."Game:Difference"..msg.chat_id)
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Tepthon.."Game:Example"..msg.chat_id) then
if text == Redis:get(Tepthon.."Game:Example"..msg.chat_id) then 
Redis:del(Tepthon.."Game:Example"..msg.chat_id)
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Tepthon.."All:Get:Reides:Commands:Group"..text) or Redis:get(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(Tepthon.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(Tepthon.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(Tepthon.."chfalse")
Redis:set(Tepthon.."chfalse",ch)
Redis:del(Tepthon.."ch:admin")
Redis:set(Tepthon.."ch:admin",data.result.invite_link)
else
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Tepthon..'Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(Tepthon..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Tepthon.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Tepthon.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Tepthon.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Tepthon.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Tepthon.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Tepthon.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه تيبثون' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
Redis:sadd(Tepthon.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Tepthon.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Tepthon.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Tepthon.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Tepthon.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم استرجاع المجموعات من نسخه تيبثون')
else
...
--download('https://raw.githubusercontent.com/بحبك/master/Tepthon.lua','Tepthon.lua')
...
Redis:del(Tepthon.."Sen:Jabwa:Bot") 
...
Redis:set(Tepthon.."Sen:Jabwa:Bot",true) 
...
Redis:del(Tepthon.."Left:Jabwa:Bot") 
...
Redis:set(Tepthon.."Left:Jabwa:Bot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Tepthon.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Tepthon.."AddSudosNew"..msg_chat_id)
...
Redis:set(Tepthon.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(Tepthon..'ChekBotAdd')  
local UsersBot = Redis:smembers(Tepthon..'Num:User:Pv')  
...
local President = Redis:smembers(Tepthon.."TheBasics:Group"..v)
local Constructor = Redis:smembers(Tepthon.."Originators:Group"..v)
local Manager = Redis:smembers(Tepthon.."Managers:Group"..v)
local Admin = Redis:smembers(Tepthon.."Addictive:Group"..v)
local Vips = Redis:smembers(Tepthon.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(Tepthon..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(Tepthon..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(Jabwaa.id,Tepthon).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Tepthon..'Channel:Join',ChannelUser) 
...
Redis:set(Tepthon..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:del(Tepthon..'Channel:Join')
...
local Channel = Redis:get(Tepthon..'Channel:Join')
if Channel then
...
Redis:set(Tepthon..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(Tepthon)
local Jabwa = LuaTele.getUser(Tepthon)
for Name_User in string.gmatch(Jabwa.first_name, "[^%s]+" ) do
Jabwa.first_name = Name_User
break
end 
NamesBot = (Redis:get(Tepthon.."Name:Bot") or "تيبثون")
Groups = (Redis:scard(Tepthon..'ChekBotAdd') or 0)
Users = (Redis:scard(Tepthon..'Num:User:Pv') or 0)
if photo.total_count > 0 then
...
if Redis:sismember(Tepthon.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Tepthon..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Tepthon..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Tepthon.."ChekBotAdd",msg_chat_id)
Redis:set(Tepthon.."Status:Id"..msg_chat_id,true) ;Redis:set(Tepthon.."Status:Reply"..msg_chat_id,true) ;Redis:set(Tepthon.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Tepthon.."Status:BanId"..msg_chat_id,true) ;Redis:set(Tepthon.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Tepthon.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Tepthon.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Tepthon.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Tepthon.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(Tepthon.."Status:Id"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Tepthon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Tepthon..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Tepthon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Tepthon.."Set:Id:Groups") or Redis:get(Tepthon.."Set:Id:Group"..msg_chat_id)
if Redis:get(Tepthon.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Tepthon..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Tepthon..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Tepthon.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Tepthon.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(Tepthon.."allM:numdel"..msg.chat_id,Numbardel) 
...
if not Redis:sismember(Tepthon.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ✧ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Tepthon.."DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."P17_12:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Tepthon.."P17_12:Groups")
Redis:del(Tepthon.."P17_12:Groups", Jabwaa.id)
Redis:del(Tepthon.."id:P17_12:Groups", Jabwaa.id)
...
if not Redis:sismember(Tepthon.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tepthon.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."P17_12:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Tepthon.."P17_12:Groups")
Redis:del(Tepthon.."P17_12:Groups", Message_Reply.sender.user_id)
Redis:del(Tepthon.."id:P17_12:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(Tepthon.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tepthon.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "كلب" then
if not Redis:sismember(Tepthon.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(Tepthon.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "قلبي" then
if not Redis:sismember(Tepthon.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").Tepthon,"md",true)  
end
end
if TextMsg == "بقره" then
if not Redis:sismember(Tepthon.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "ارمله" then
if not Redis:sismember(Tepthon.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "حمار" then
if not Redis:sismember(Tepthon.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "خول" then
if not Redis:sismember(Tepthon.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "مزه" then
if not Redis:sismember(Tepthon.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "وتكه" then
if not Redis:sismember(Tepthon.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "ابني" then
if not Redis:sismember(Tepthon.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "بنتي" then
if not Redis:sismember(Tepthon.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "خاين" then
if not Redis:sismember(Tepthon.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").Tepthon,"md",true)  
else
Redis:srem(Tepthon.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").Tepthon,"md",true)  
end
end
end
...
if not Redis:sismember(Tepthon.."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ✧ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Tepthon.."DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Tepthon.."P17_12:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Tepthon.."P17_12:Groups")
Redis:del(Tepthon.."P17_12:Groups", UserId)
Redis:del(Tepthon.."id:P17_12:Groups", UserId)
...
if not Redis:sismember(Tepthon.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Developers:Groups",UserId) 
...
if not Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tepthon.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Tepthon.."P17_12:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Tepthon.."P17_12:Groups")
Redis:sadd(Tepthon.."P17_12:Groups", UserId)
Redis:set(Tepthon.."id:P17_12:Groups", UserId)
...
if Redis:sismember(Tepthon.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Tepthon.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Tepthon.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Tepthon.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."P17_12:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Tepthon.."P17_12:Groups")
Redis:sadd(Tepthon.."P17_12:Groups", Message_Reply.sender.user_id)
Redis:set(Tepthon.."id:P17_12:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(Tepthon.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Tepthon.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "متوحد" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Tepthon.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✧ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(Tepthon.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "كلب" then
...
if Redis:sismember(Tepthon.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "قرد" then
...
if Redis:sismember(Tepthon.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "قلبي" then
...
if Redis:sismember(Tepthon.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").Tepthon,"md",true)  
end
end
if TextMsg == "بقره" then
...
if Redis:sismember(Tepthon.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "ارمله" then
...
if Redis:sismember(Tepthon.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "حمار" then
...
if Redis:sismember(Tepthon.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "خول" then
...
if Redis:sismember(Tepthon.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "مزه" then
...
if Redis:sismember(Tepthon.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "وتكه" then
...
if Redis:sismember(Tepthon.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "ابني" then
...
if Redis:sismember(Tepthon.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "بنتي" then
...
if Redis:sismember(Tepthon.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").Tepthon,"md",true)  
end
end
if TextMsg == "خاين" then
...
if Redis:sismember(Tepthon.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").Tepthon,"md",true)  
else
Redis:sadd(Tepthon.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").Tepthon,"md",true)  
end
end
end
...
if Redis:sismember(Tepthon.."P17_12:Groups",UserId) then
...
if Redis:sismember(Tepthon.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Developers:Groups",UserId) 
...
if Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Tepthon.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Tepthon.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Tepthon.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Tepthon.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Tepthon.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Tepthon.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Tepthon.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Tepthon.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Tepthon.."Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• sᴏᴜʀᴄᴇ ᴛᴇᴘᴛʜᴏɴ •𓄹', url = "http://t.me/Tepthon"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(Tepthon.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Monkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Myheart:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."acow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."widow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."let:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."donkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Beautiful:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."tick:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."myson:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."daughter:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."betray:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Jabwa:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."Jabwa:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tepthon.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Tepthon.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Tepthon.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Status:Id"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(Tepthon.."BotFree",true) 
...
Redis:set(Tepthon.."TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Tepthon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Tepthon.."Tepthon1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Tepthon..'AddRd:Sudo:Text'..text..msg.chat_id)
Redis:del(Tepthon..'AddRd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Tepthon..'AddRd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Tepthon.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id)
...
for k,v in pairs(list) do  
Redis:del(Tepthon.."AddRd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Tepthon.."AddRd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Tepthon.."AddRd:Sudo:Text2"..v..msg.chat_id) 
...
Redis:set(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Tepthon.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Tepthon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."AddRd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Tepthon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."AddRd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Tepthon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Tepthon.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."AddRd:Sudo:Text2"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Tepthon.."AddRd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Tepthon.."AddRd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Tepthon.."AddRd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Tepthon.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Tepthon.."Tepthon11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Tepthon.."SetOn"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Tepthon..'Add:Rd:Sudo:Text'..text)
Redis:del(Tepthon..'Add:Rd:Sudo:Text1'..text)
Redis:del(Tepthon..'Add:Rd:Sudo:Text2'..text)
Redis:del(Tepthon.."SetOn"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Tepthon.."Tepthon11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Tepthon.."Tepthon11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Tepthon.."Add:Rd:Sudo:Text"..v) 
Redis:del(Tepthon.."Add:Rd:Sudo:Text1"..v) 
Redis:del(Tepthon.."Add:Rd:Sudo:Text2"..v)   
Redis:del(Tepthon.."Tepthon11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Tepthon.."SetOn"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Tepthon.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(Tepthon.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Tepthon.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Tepthon.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tepthon.."Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Tepthon.."Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Tepthon.."Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Tepthon.."Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Tepthon.."Almayu"..msg.chat_id, msg.id)
if Redis:get(Tepthon.."Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Tepthon.."Almayu"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Tepthon.."Almayu"..msg.chat_id)
...
Redis:del(Tepthon.."Almayu"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Tepthon.."Almayu"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Tepthon.."Almayu"..msg.chat_id)  
...
Redis:del(Tepthon.."Status:Del:Media"..msg.chat_id)
...
Redis:set(Tepthon.."Status:Del:Media"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(Tepthon.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Tepthon.."Status:Welcome"..msg_chat_id) 
...
Redis:del(Tepthon.."Status:Id"..msg_chat_id) 
...
Redis:del(Tepthon.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Tepthon.."Status:Reply"..msg_chat_id) 
...
Redis:del(Tepthon.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Tepthon.."Status:BanId"..msg_chat_id) 
...
if not msg.Originators and not Redis:get(Tepthon.."Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(Tepthon.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'Jabwaned',0)
...
if not Redis:sismember(Tepthon.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Tepthon.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Tepthon.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Tepthon.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(Tepthon.."Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"✧ تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local bain = LuaTele.getUser(msg.sender.user_id)
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').."احظرو عام" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." حظر عام" or text == 'حظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(Tepthon.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Tepthon.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء حظر عام" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء الحظر عام" or text == "الغاء حظر عام" or text == 'الغاء الحظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(2)..' 〙* ',"md",true)  
end
...
if not Redis:sismember(Tepthon.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." اكتمو عام" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." كتم عام" or text == ('كتم عام') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(Tepthon.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Tepthon.."ktmAll:Groups",Message_Reply.sender.user_id) 
if Jabwa.first_name then
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء الكتم العام" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').."الغاء كتم العام" or text == 'الغاء كتم العام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if not Redis:sismember(Tepthon.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." احظرو" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').."حظر" or text == 'حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(Tepthon.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Tepthon.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
if Jabwa.first_name then
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء الحظر" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء حظر" or text == 'الغاء حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(Tepthon.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." اكتمو" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." كتم" or text == 'كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(Tepthon.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Tepthon.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if Jabwa.first_name then
Jabwaiusername = '*الـعـضـو -› *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..' 〙*\nتـم كـتـمـه فـي الـجـروب\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
Jabwaiusername = 'لا يوجد'
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء الكتم" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء كتم" or text == 'الغاء كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(Tepthon.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tepthon.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end

if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." تقيد" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." تقييد" or text == 'تقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').."الغاء التقيد" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." الغاء التقييد" or text == 'الغاء التقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." اطرد ده" or text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." طرد" or text == 'طرد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if UserId == "1260465030" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على المطور محمد  *","md",true)  
end
if Redis:sismember(Tepthon.."BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."BanAll:Groups",UserId) 
...
if Redis:sismember(Tepthon.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
baniusername = '*الـعـضـو -› *['..ban.first_name..'](tg://user?id='..ban.id..')*\n✧ تـم حـظـره مـن الـجـروب \nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(Tepthon.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Tepthon.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Tepthon.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tepthon.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*الـعـضـو -› *['..ban.first_name..'](tg://user?id='..ban.id..')*\n✧ تـم كـتـمـه فـي الـجـروب\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(Tepthon.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Tepthon.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Tepthon.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Tepthon.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Tepthon.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Tepthon.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Tepthon.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(Tepthon.."Status:KickMe"..msg_chat_id) then
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @Tepthon"..Creator.."\n"
else
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Tepthon.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Tepthon.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local id = Redis:get(Tepthon.."id:P17_12:Groups")
...
local zwgat_list = Redis:smembers(Tepthon..msg_chat_id.."zwgat:")
...
local mutlqat_list = Redis:smembers(Tepthon..msg_chat_id.."mutlqat:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Tepthon.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
Redis:set(Tepthon.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(Tepthon.."Lock:text"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Tepthon.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Tepthon.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Tepthon.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Tepthon.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Tepthon.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(Tepthon.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Tepthon..'close'..lock..msg_chat_id,"del")    
end
...
Redis:del(Tepthon.."Lock:AddMempar"..msg_chat_id)  
...
Redis:hset(Tepthon.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(Tepthon.."Lock:text"..msg_chat_id)  
...
Redis:del(Tepthon.."Lock:Join"..msg_chat_id)  
...
Redis:del(Tepthon.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Tepthon.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(Tepthon.."lockpin"..msg_chat_id)  
...
Redis:del(Tepthon.."Lock:edit"..msg_chat_id) 
...
Redis:del(Tepthon.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Tepthon..'Open'..lock..msg_chat_id)    
end
...
Redis:hset(Tepthon.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Tepthon.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Tepthon.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Tepthon.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Tepthon.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Tepthon.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Link"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(Tepthon..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(Tepthon..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(Tepthon..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(Tepthon..'lock:Fshar'..msg.chat_id) 
...
Redis:del(Tepthon..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(Tepthon..'lock:Fars'..msg.chat_id) 
...
Redis:del(Tepthon.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Photo"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Video"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Animation"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:geam"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Audio"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:vico"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:forward"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Document"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Contact"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Spam"..msg_chat_id)  
...
Redis:set(Tepthon.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Tepthon.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Tepthon.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Tepthon.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Tepthon.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Tepthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(Tepthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Tepthon.."Status:Welcome"..msg_chat_id) then
...
Redis:del(Tepthon.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(Tepthon.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Tepthon.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Tepthon.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Tepthon.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Tepthon.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Tepthon.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Tepthon.."Filter:Group"..v..msg_chat_id)  
Redis:srem(Tepthon.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Tepthon.."Filter:Group"..v..msg_chat_id)   
...
Redis:set(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Tepthon..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Tepthon.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Tepthon.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Tepthon.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Tepthon.."All:Get:Reides:Commands:Group"..v)
Redis:del(Tepthon.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Tepthon.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Tepthon.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Tepthon.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Tepthon.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Tepthon.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ 〘 "..Commands.." 〙\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Tepthon.."Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:Jabwa"..msg.chat_id)  then
StatusJabwaId = '【 ✅ 】' else StatusJabwaId = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(Tepthon.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴛᴇᴘᴛʜᴏɴ •𓄹', url = 't.me/Tepthon'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Tepthon.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Tepthon.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
if Redis:sismember(Tepthon.."DevelopersQ:Groups",bana.id) then
devQ = "المطور الثانوي ✧" 
else 
devQ = "" 
end
if Redis:sismember(Tepthon.."Developers:Groups",bana.id) then
dev = "المطور ✧" 
else 
dev = "" 
end
if Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
crrQ = "المالك ✧" 
else 
crrQ = "" 
end
if Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id, bana.id) then
crr = "منشئ اساسي ✧" 
else 
crr = "" 
end
if Redis:sismember(Tepthon..'Originators:Group'..msg_chat_id, bana.id) then
cr = "منشئ ✧" 
else 
cr = "" 
end
if Redis:sismember(Tepthon..'Managers:Group'..msg_chat_id, bana.id) then
own = "مدير ✧" 
else 
own = "" 
end
if Redis:sismember(Tepthon..'Addictive:Group'..msg_chat_id, bana.id) then
mod = "ادمن ✧" 
else 
mod = "" 
end
if Redis:sismember(Tepthon..'Distinguished:Group'..msg_chat_id, bana.id) then
vip = "مميز ✧" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(Tepthon.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(Tepthon.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(Tepthon.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(Tepthon.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(Tepthon.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(Tepthon.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(Tepthon.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(Tepthon.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Tepthon.."DevelopersQ:Groups",bana.id)
Redis:srem(Tepthon.."Developers:Groups",bana.id)
Redis:srem(Tepthon.."TheBasicsQ:Group"..msg_chat_id, bana.id)
Redis:srem(Tepthon.."TheBasics:Group"..msg_chat_id, bana.id)
Redis:srem(Tepthon.."Originators:Group"..msg_chat_id, bana.id)
Redis:srem(Tepthon.."Managers:Group"..msg_chat_id, bana.id)
Redis:srem(Tepthon.."Addictive:Group"..msg_chat_id, bana.id)
Redis:srem(Tepthon.."Distinguished:Group"..msg_chat_id, bana.id)
elseif msg.DevelopersQ then
if Rink == 2 or Rink < 2 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*✧ لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
...
Redis:del(Tepthon..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Tepthon..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Tepthon..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد رسائلك هنا ⇦ '..(Redis:get(Tepthon..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد التعديلات هنا ⇦ '..(Redis:get(Tepthon..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد جهاتك يبشا ⇦ '..(Redis:get(Tepthon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(Tepthon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✧ ارسل الان النص
 ✧ يمكنك اضافه :
...
Redis:del(Tepthon.."Set:Id:Groups")
...
Redis:setex(Tepthon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✧ ارسل الان النص
 ✧ يمكنك اضافه :
 ✧ `#username` ‹- اسم المستخدم
...
Redis:del(Tepthon.."Set:Id:Group"..msg.chat_id)
...
Redis:del(Tepthon.."DevelopersQ:Groups") 
...
Redis:del(Tepthon.."Developers:Groups") 
...
Redis:del(Tepthon.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(Tepthon.."Originators:Group"..msg_chat_id) 
...
Redis:del(Tepthon.."Managers:Group"..msg_chat_id) 
...
Redis:del(Tepthon.."Addictive:Group"..msg_chat_id) 
...
Redis:del(Tepthon.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(Tepthon.."Jabwa:Groups") 
...
Redis:del(Tepthon.."ktmAll:Groups") 
...
Redis:del(Tepthon.."Jabwa:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Tepthon.."MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Tepthon.."MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(Tepthon.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Tepthon.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Tepthon.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Tepthon.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Tepthon.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Tepthon.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Tepthon.."List:Manager"..msg_chat_id)
end
...
text = " ✧ قائمه الردود ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 𝐓𝐄𝐏𝐓𝐇𝐎𝐍  𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(Tepthon.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Tepthon.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Tepthon.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Tepthon.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Tepthon.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Tepthon.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Tepthon.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 📩 "
elseif Redis:get(Tepthon.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Tepthon.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Tepthon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id," ✧ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(Tepthon.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(Tepthon.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(Tepthon.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Tepthon.."Add:Rd:Sudo:Gif"..v)   
Redis:del(Tepthon.."Add:Rd:Sudo:vico"..v)   
Redis:del(Tepthon.."Add:Rd:Sudo:stekr"..v)     
Redis:del(Tepthon.."Add:Rd:Sudo:Text"..v)   
Redis:del(Tepthon.."Add:Rd:Sudo:Photoc"..v)
Redis:del(Tepthon.."Add:Rd:Sudo:Photo"..v)
Redis:del(Tepthon.."Add:Rd:Sudo:Video"..v)
Redis:del(Tepthon.."Add:Rd:Sudo:File"..v)
Redis:del(Tepthon.."Add:Rd:Sudo:Audio"..v)
Redis:del(Tepthon.."Add:Rd:Sudo:video_note"..v)
Redis:del(Tepthon.."List:Rd:Sudo")
end
...
text = "\n✧ قائمة الردود العامه ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 𝐒𝐀??𝐃𝐈 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(Tepthon.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:File"..v) then
db = "ملف 📩 "
elseif Redis:get(Tepthon.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Tepthon.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(Tepthon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Tepthon.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Tepthon.."SendBcBot") then
...
Redis:setex(Tepthon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Tepthon.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Tepthon.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Tepthon.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Tepthon.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local Added_Me = Redis:get(Tepthon.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
JabwaAll = '✧ محظور عام'
Redis:srem(Tepthon.."Jabwa:Groups",Message_Reply.sender.user_id) 
else
JabwaAll = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).JabwaGroup == true then
JabwaGroup = '✧ محظور'
Redis:srem(Tepthon.."Jabwa:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
...
JabwaAll = '✧ محظور عام'
Redis:srem(Tepthon.."Jabwa:Groups",UserId_Info.id) 
else
JabwaAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).JabwaGroup == true then
JabwaGroup = '✧ محظور'
Redis:srem(Tepthon.."Jabwa:Group"..msg_chat_id,UserId_Info.id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
SilentGroup = '✧ مكتوم'
Redis:srem(Tepthon.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
else
SilentGroup = ''
end
LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم رفع القيود عنه -› 〘 "..JabwaAll..JabwaGroup..SilentGroup..Restricted..' 〙*',"md",true)  
...
Redis:set(Tepthon..'GetTexting:DevTepthon'..msg_chat_id..':'..msg.sender.user_id,true)
...
if text == "صورتي" then
if Redis:get(Tepthon.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴛᴇᴘᴛʜᴏɴ •𓄹', url = "http://t.me/Tepthon"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/faioo8/'..Tepthon..'&caption=' .. URL.escape(Jabwaiusername).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local Mostafa = (Redis:get(Tepthon.."Name:Bot") or "تيبثون")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "http://t.me/Tepthon"
local Name = '*𓄼• ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴛᴇᴘᴛʜᴏɴ*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• - 𝐷𝐸𝑉 𝑀𝑂𝐻𝐴𝑀𝑀𝐴𝐷 𝅘𝅥𝅯.𓄹', url = "https://t.me/P17_12"}
},
{
{text = '𓄼• sᴏᴜʀᴄᴇ ᴛᴇᴘᴛʜᴏɴ •𓄹', url = "http://t.me/Tepthon"}
},
...
if text == 'محمد ' or text == 'المطور محمد ' or text == 'مطور السورس' then
photo = "https://t.me/P17_12"
local Name = '*المطور محمد  مطور السورس لو حاابب تتواصل معاه بالاسفل ⬇️*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• - 𝐷𝐸𝑉 𝑀𝑂𝐻𝐴𝑀𝑀𝐴𝐷 𝅘𝅥𝅯.𓄹', url = "https://t.me/P17_12"}
...
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ اليك قسم الالعاب من سورس تيبثون ',"md",false, false, false, false, reply_markup)
end
if Redis:get(Tepthon.."zhrfa"..msg.sender.user_id) == "sendzh" then
zh = https.request('https://apiTepthon.ml/zrf.php?Tepthon='..URL.escape(text)..'')
zx = JSON.decode(zh)
...
Redis:del(Tepthon.."zhrfa"..msg.sender.user_id) 
end
if text == "زخرفه" or text == "زخرفة" then
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(Tepthon.."zhrfa"..msg.sender.user_id,"sendzh") 
end
if text and text:match("^زخرفه (.*)$") then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://apiTepthon.ml/zrf.php?Tepthon='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n* ✧ قائمه الزخرفه ⇧⇩*\n*⩹┉┉┉┉⊶❲𖥳𝐓𝐄𝐏𝐓𝐇𝐎𝐍  𖥳❳⊷┉┉┉┉⩺*\n* أضغط علي الاسم لا يتم النسخ ✧ *\n"
i = 0
for k,v in pairs(zx.ok) do
...
if Redis:get(Tepthon.."brgi"..msg.sender.user_id) == "sendbr" then
gk = https.request('https://apiTepthon.ml/brg.php?brg='..URL.escape(text)..'')
br = JSON.decode(gk)
i = 0
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(Tepthon.."brgi"..msg.sender.user_id) 
end
if text == "الابراج" or text == "برجي" then
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل البرج الان لعرض التوقعات*","md",true) 
Redis:set(Tepthon.."brgi"..msg.sender.user_id,"sendbr") 
end
if text and text:match("^برج (.*)$") then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://apiTepthon.ml/brg.php?brg='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
for k,v in pairs(br.ok) do
i = i + 1
...
if Redis:get(Tepthon.."Status:kool"..msg.chat_id) then
...
if Redis:sismember(Tepthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(Tepthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(Tepthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(Tepthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Tepthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(Tepthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(Tepthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if not Redis:get(Tepthon.."Jabwa:Jeka"..msg_chat_id) then
...
Redis:setex(Tepthon.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local photo = LuaTele.getUserProfilePhotos(Tepthon)
local Jabwa = LuaTele.getUser(Tepthon)
local NamesBot = (Redis:get(Tepthon.."Name:Bot") or "تيبثون")
local BotName = {
...
if text == (Redis:get(Tepthon.."Name:Bot") or "تيبثون") then
local photo = LuaTele.getUserProfilePhotos(Tepthon)
local Jabwa = LuaTele.getUser(Tepthon)
local NamesBot = (Redis:get(Tepthon.."Tepthon:Name:Bot") or "تيبثون")
local BotName = {
'نعم يروحي 🌝💙',
'نعم يا قلب '..NamesBot..'',
'عوز اي مني '..NamesBot..'',
...
if text == (Redis:get(Tepthon.."Name:Bot") or 'تيبثون').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص 〘 '..Controller_Num(3)..' 〙* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(Tepthon.."Left:Jabwa:Bot") then
...
x = x + 1
Redis:srem(Tepthon..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(Tepthon..'ChekBotAdd',Get_Chat.id)
...
Redis:srem(Tepthon..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Tepthon.."Game:Smile"..msg.chat_id,SM)
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس تيبثون؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس تيبثون؟ ", 
"كم مره حبيت؟ ", 
...
if Redis:get(Tepthon.."Status:Games"..msg.chat_id) then
Redis:del(Tepthon.."Set:Country"..msg.chat_id)
...
Redis:set(Tepthon.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(Tepthon.."Game:Jabwa"..msg.chat_id,name)
...
Redis:set(Tepthon.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Tepthon.."Status:Games"..msg.chat_id) then
Redis:del(Tepthon.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Tepthon.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Tepthon.."Status:Games"..msg.chat_id) then
Redis:del(Tepthon.."SetAks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Tepthon.."Gamection"..msg.chat_id,name)
...
Redis:set(Tepthon.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Tepthon.."Game:Difference"..msg.chat_id,name)
...
Redis:set(Tepthon.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Tepthon.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Tepthon.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Tepthon.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Tepthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Tepthon.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(Tepthon..'Num:User:Pv',msg.sender.user_id)  
if not msg.DevelopersQ then
if not Redis:get(Tepthon.."Start:Bot") then
local CmdStart = '*\n ✧ أهلا بك في بوت '..(Redis:get(Tepthon.."Name:Bot") or "تيبثون")..
...
Redis:setex(Tepthon.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
local Info_Members = Redis:smembers(Tepthon.."BanAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(Tepthon.."BanAll:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم مسح  〘 "..#Info_Members.." 〙 من المحظورين عام *","md",true)
end
...
if not msg.ControllerBot then
if Redis:get(Tepthon.."TwaslBot") and not Redis:sismember(Tepthon.."Jabwa:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Tepthon.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Tepthon.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Tepthon..'Jabwa:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ✧ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Tepthon..'Jabwa:In:Tuasl',Info_User)  
...
Redis:srem(Tepthon.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Tepthon..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Tepthon.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(Tepthon.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Tepthon.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tepthon.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Tepthon.."Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Tepthon..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:incr(Tepthon..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Tepthon.."Lock:edit"..data.chat_id) then
...
Redis:del(Tepthon.."Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Tepthon.."Set:array"..IdUser..":"..ChatId)
Redis:del(Tepthon.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Tepthon.."Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Tepthon.."Set:array"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Tepthon.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id," ✧  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Tepthon.."Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id," ✧  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Tepthon.."Num:Add:Games"..ChatId..IdUser, 1)  
...
local inget = Redis:get(Tepthon..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(Tepthon..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(Tepthon..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/faioo8/'..Tepthon..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/emeuii/'..Tepthon..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس تيبثون اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس تيبثون 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tepthon.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tepthon.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tepthon.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tepthon.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Jabwa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:Jabwa"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Jabwa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:Jabwa"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tepthon.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Tepthon.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Tepthon.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Tepthon.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Tepthon..'close'..lock..UserId[2],"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Tepthon..'Open'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Tepthon.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tepthon.."Redisa:Groups") 
